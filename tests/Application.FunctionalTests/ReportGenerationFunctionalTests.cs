...
namespace Application.FunctionalTests
{
    public class ReportGenerationFunctionalTests(ApplicationFixture fixture) : IClassFixture<ApplicationFixture>
    {
        ...
        public async Task CanGenerateReport()
        {
            ...
            Bet secondBet = await fixture.BetApi.PlaceBetAsync(customer.Id, betTypeId: BetType.Double, maxReturns: 200, totalOdds: 4, totalStake: 35, inPlay: true).WithDelay(1000);
            await fixture.BetApi.ResultBetAsync(id: secondBet.Id, win: false);
            await fixture.BetApi.SettleBetAsync(id: secondBet.Id);

            Bet thirdBet = await fixture.BetApi.PlaceBetAsync(customer.Id, betTypeId: BetType.Triple, maxReturns: 150, totalOdds: 3, totalStake: 100, inPlay: false).WithDelay(1000);
